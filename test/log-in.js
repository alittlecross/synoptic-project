...
import { dbLogInOne, dbLogInTwo } from "./support.js";

import LogIn from "../server/lib/log-in.js";
import DatabasePeople from "../server/services/people.js";
...
describe("class LogIn", () => {
  ...
  describe(".authenticate", () => {
    it("should query the database for a person with the given username", async () => {
      const authenticate = sandbox
        .stub(DatabasePeople, "authenticate")
        .returns(dbLogInTwo);
